          ...
          <ul class="featuredListing row">
            ...
            <li class="col-md-6">
              ...
              <div class="profileInfo">
                ...
                <p><?php echo count_years($row->dob,date("Y-m-d"));?></p>
                <p><?php echo $row->city;?>, <?php echo $row->country;?></p>                
              
              	<a href="<?php echo base_url(); ?>friends/unblock_friend/<?php echo my_encrypt($row->id); ?>" class="chatbtn" title="Accept this Request">Add friend</a>
              </div>
